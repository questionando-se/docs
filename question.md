...
O campo *content* é obrigatório e remete ao conteúdo da questão e tem como formato, um array de objetos que devem se caracterizar como a interface do *TypeScript* **QuestionFileContent**:
